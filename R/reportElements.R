...
doc_container<-R6::R6Class(
  ...
  public = list(
    initialize=function(parent, tags, depth_weight=1, chart_foldername='', cache_foldername='') {
      ...
      private$depth_weight_<-depth_weight
...
#1. as a holder of statistical methods
#2. as a holder output generated by a statistics generator
doc_Void_Document<-R6::R6Class(
  "doc_Void_Document",
  inherit = doc_section,
  public = list(
    initialize=function(parent=NULL, chart_foldername='', cache_foldername='', section_text='', depth_weight=1) {
      super$initialize(parent = parent, tags = character(0), text=section_text, depth_weight=depth_weight,
                       chart_foldername=chart_foldername,
                       cache_foldername=cache_foldername)
    },
    render=function(doc) {
      #Do nothing
    ...
    insert_section=function(text, tags=character(0), chart_foldername='', cache_foldername='') {
      #Fake everything
      sec<-doc_Void_Document$new(parent = self, chart_foldername = chart_foldername, cache_foldername = cache_foldername, section_text=text)
      self$add_element(sec)
      return(sec)
    },
    insert_table=function(caption, table_df, tags=character(0), flag_header_in_md=FALSE,
